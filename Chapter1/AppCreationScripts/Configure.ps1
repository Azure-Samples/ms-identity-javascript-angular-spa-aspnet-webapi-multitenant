...
#> 
   ...
   Write-Host "Done creating the spa application (multitenant-spa)"
   ...
   Add-Content -Value "<tr><td>spa</td><td>$currentAppId</td><td><a href='$spaPortalUrl'>multitenant-spa</a></td></tr>" -Path createdApps.html
